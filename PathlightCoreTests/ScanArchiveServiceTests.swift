...
final class ScanArchiveServiceTests: XCTestCase {
    ...
    func testExportRejectsWrongArchiveExtension() async throws {
        ...
        do {
            ...
            XCTFail("Export should reject destinations without the .pathlightscan extension.")
        } catch ScanArchiveError.invalidArchivePackage(let detail) {
            XCTAssertTrue(detail.contains(".pathlightscan"))
        }
    ...
    func testImportRejectsWrongArchiveExtension() async throws {
        ...
        do {
            ...
            XCTFail("Preview should reject packages without the .pathlightscan extension.")
        } catch ScanArchiveError.invalidArchivePackage(let detail) {
            XCTAssertTrue(detail.contains(".pathlightscan"))
        }
        ...
        do {
            ...
            XCTFail("Import should reject packages without the .pathlightscan extension.")
        } catch ScanArchiveError.invalidArchivePackage(let detail) {
            XCTAssertTrue(detail.contains(".pathlightscan"))
        }
    }

    ...
    var body: some View {
        Form {
            Section("Scanning") {
                ...
                Text("When off, Pathlight skips ~/Library/CloudStorage (Google Drive, Dropbox, OneDrive, and similar sync folders) and iCloud Drive at ~/Library/Mobile Documents.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
    ...
    var body: some View {
        Form {
            Section("Full Disk Access") {
                Text("Pathlight can scan ordinary folders immediately. For protected macOS locations such as Mail, Safari, Messages, and Library content, grant Full Disk Access in System Settings.")
                    .foregroundStyle(.secondary)
            ...
            Section("File Actions") {
                Text("Reveal, Open, Copy Path, and Move to Trash always act on the current visible selection. Pathlight stays read-only unless you explicitly choose a file action.")
                    .foregroundStyle(.secondary)
                    .fixedSize(horizontal: false, vertical: true)
            }
            ...
            Section("Usage Stats") {
                Text("Stats are stored locally on this Mac. Pathlight records aggregate counts and sizes only.")
                    .foregroundStyle(.secondary)
                    .fixedSize(horizontal: false, vertical: true)
...
private struct SpaceExploredHero: View {
    ...
    private var valueText: String {
        ...
        return PathlightFormatters.size(displayedBytes)
    }

...
struct InspectorDetailsSections: View {
    ...
    var body: some View {
        Section("Key Stats") {
            InspectorKeyStats(
                allocatedSize: PathlightFormatters.size(node.allocatedSize),
        ...
        Section("Metadata") {
            ...
            LabeledContent("Logical Size") {
                Text(PathlightFormatters.size(node.logicalSize))
            }
            ...
            LabeledContent("Modified") {
                Text(PathlightFormatters.date(node.lastModified))
            }

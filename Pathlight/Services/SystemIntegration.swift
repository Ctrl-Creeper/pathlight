...
enum SystemIntegration {
    ...
    enum SystemIntegrationError: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .protectedTrashLocation(let path):
                return "Pathlight will not move the protected location at \(path) to the Trash."
            }
        }
    }
    ...
    private static var pathlightScanArchiveContentType: UTType {
    ...
    static func presentExportScanPanel(defaultFileName: String) async -> URL? {
        ...
        panel.allowedContentTypes = [pathlightScanArchiveContentType]

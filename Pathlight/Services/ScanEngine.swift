...
actor ScanEngine {
    ...
    private enum ScanConcurrencyPolicy {
        ...
        static func atomicSummaryWorkerLimit(for options: ScanOptions) -> Int {
            ...
            if let environmentLimit = ProcessInfo.processInfo.environment["PATHLIGHT_SCAN_ATOMIC_SUMMARY_WORKERS"]
                .flatMap(Int.init) {
        ...
        static func directoryTraversalWorkerLimit(for options: ScanOptions) -> Int {
            ...
            if let environmentLimit = ProcessInfo.processInfo.environment["PATHLIGHT_SCAN_DIRECTORY_TRAVERSAL_WORKERS"]
                .flatMap(Int.init) {
                return max(1, environmentLimit)
            }
        ...
        static func directoryClassificationWorkerLimit(for options: ScanOptions) -> Int {
            ...
            if let environmentLimit = ProcessInfo.processInfo.environment["PATHLIGHT_SCAN_DIRECTORY_CLASSIFICATION_WORKERS"]
                .flatMap(Int.init) {
                return max(1, environmentLimit)
            }
